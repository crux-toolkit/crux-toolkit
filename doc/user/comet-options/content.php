<div id="page">
   <div id="content_full">
      <div class="post hr">
         ...
         Here is an example <a href="comet.params">comet.params</a> file.
         Here's a link to <a href="combined.php">all parameter descriptions on a single web page</a>.</p>
         ...
         <ul>
         <li><a href="variable_mod1.php">variable_mod1</a></li>
         <li><a href="variable_mod2.php">variable_mod2</a></li>
         <li><a href="variable_mod3.php">variable_mod3</a></li>
         <li><a href="variable_mod4.php">variable_mod4</a></li>
         <li><a href="variable_mod5.php">variable_mod5</a></li>
         <li><a href="variable_mod6.php">variable_mod6</a></li>
         <li><a href="max_variable_mods_in_peptide.php">max_variable_mods_in_peptide</a></li>
         <li><a href="variable_C_terminus.php">variable_C_terminus</a></li>
         <li><a href="variable_N_terminus.php">variable_N_terminus</a></li>
         <li><a href="variable_C_terminus_distance.php">variable_C_terminus_distance</a></li>
         <li><a href="variable_N_terminus_distance.php">variable_N_terminus_distance</a></li>
         </ul>
