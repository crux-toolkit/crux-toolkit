  ...
  # Set names of files available for download
   if (isset($_POST['release_button'])) {
     $FileNameBaseArray = array(
       "Source" => "crux-3.1.Source.tar.gz",
       "Linux32" => "crux-3.1.Linux.i686.zip",
       "Linux64" => "crux-3.1.Linux.x86_64.zip",
       "OSX" => "crux-3.1.Darwin.x86_64.zip",
       "Windows64" => "crux-3.1.Windows.AMD64.zip",
       "Windows32" => "crux-3.1.Windows.i386.zip",
     );
     $directory = "crux-3.1/";
   }
    else {
      ...
      $FileNameBaseArray = array(
        "Source" => "crux-3.1.$version.Source.tar.gz",
        "Linux32" => "crux-3.1.$version.Linux.i686.zip",
        "Linux64" => "crux-3.1.$version.Linux.x86_64.zip",
        "OSX" => "crux-3.1.$version.Darwin.x86_64.zip",
        "Windows64" => "crux-3.1.$version.Windows.AMD64.zip",
        "Windows32" => "crux-3.1.$version.Windows.i386.zip",
      );
      $directory = "daily/";
    }
