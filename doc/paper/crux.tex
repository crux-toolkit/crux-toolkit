...
% BILL after looking at the code, the changes to this paragraph that
% discussed seem correct. We cached the decoy peptide so that we 
% use the same decoy peptide(s) for e.g Xcorr and Sp
