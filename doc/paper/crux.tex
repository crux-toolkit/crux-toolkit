...
threshold of 0.01, $Xcorr$ ranking yields FIXME PSMs, ranking by
$Xcorr$ $p$~values yields FIXME PSMs, and ranking by Percolator score
yields FIXME PSMs.  It is not surprising that Percolator performs
