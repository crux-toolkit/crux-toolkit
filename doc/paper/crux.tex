...
%-- Experiments -------------
% TODO put Xcorr into the benchmarking
%      explain rationale, then say ironically we are doing better
% TODO pfile without index
% TODO add in TurboSequest
%----------------------------

%-- Response ----------------
% TODO Tandem include reverse is not the same thing as on-the-fly decoy 
% TODO use param file for differential mods
%----------------------------
...
%   \includegraphics[width=3in]{../../results/paper-figure/index/indexing-yeast.eps} & 
%  \includegraphics[width=3in]{../../results/paper-figure/turbo-no-missed/indexing-yeast-windows.eps} & 
\begin{figure}
  \centering
  \begin{tabular}{ll}
    {\sf A} & {\sf B} \\
  \includegraphics[width=3in]{../../results/paper-figure/index/indexing-human.eps} &
  \includegraphics[width=3in]{../../results/paper-figure/turbo-no-missed-human/indexing-yeast-windows.eps} \\
...
\end{tabular}
  ...
  on computers running the Linux (A) 
  or Windows (B) operating systems, using {\sc Sequest} and Crux with 
  and without indices.
  Run time is plotted 
...
% FIXME I'm not sure how we are going to present the new results
We tested Crux and {\sc Sequest} on two operating systems: Red Hat Linux and
Windows XP, a choice motivated primarily by a lack of Turbo Sequest indexing
software on the Linux operating system. Execution of Crux on Windows was performed
from within the UNIX emulator environment Cygwin, 
...
\end{figure*}
% TODO put in randomly generated spectra into supplement
...
analysis of soluble yeast whole-cell lysate on an LTQ ion trap mass spectrometer as described previously \cite{klammer:peptide2}. 
