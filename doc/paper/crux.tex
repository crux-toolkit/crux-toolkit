...
\item {\bf Efficient retrieval of candidate peptides.}  Given a
  ...
  average.
  % This is calculated by averaging the fold-decrease across the six points.
...
\end{figure}
% FIXME put in a sentence rationalizing flatness above
%---------------------------------
...
% FIXME include Ting Chen's metric indexing? \cite{dutta:speeding}
...
% FIXME include pseudo-reversal? \cite{elias:target}
...
or peptide proteotypicity.  % probably not a word! % but is proteotypic?
% FIXME more discussion
% FIXME We should make sure to mention the file-handle limit at some
% point.
...
% FIXME put in Jimmy? and his random professor?
\section*{Funding}
