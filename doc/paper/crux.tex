...
\noindent
{\bf Background}~~~Mass spectrometry, the core technology in the
...
\noindent
{\bf Methodology}~~~We describe a database search program called Crux
...
two recently described post-processing methods: a $p$~value
...
the overall rate of peptide identification.

\noindent
{\bf Significance}~~~The algorithms implemented in Crux constitute a
flexible, state-of-the-art method for identifying peptides from tandem
mass spectra in a rapid and accurate fashion.
...
pre-computed information, such as predicted peak intensities,
