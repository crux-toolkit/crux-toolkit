...
\begin{figure*}
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=3in]{./Images/fig-2-random-sp.eps} &
    \includegraphics[width=3in]{./Images/fig-2-random-xcorr.eps} \\
  A & B \\
    \includegraphics[width=3in]{./Images/fig-2-difference-sp.eps} &
    \includegraphics[width=3in]{./Images/fig-2-difference-xcorr.eps} \\
  C & D \\
  \end{tabular}
  ...
  Sp (A) and XCorr (B) scores as computed by Crux as a
  function of the same scores as computed by SEQUEST, and a histogram
  of the differences between the same scores (C,D).
  \label{figure:indexing}}
\end{figure*}
