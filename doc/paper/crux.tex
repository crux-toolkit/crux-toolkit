...
\item {\bf Two state-of-the-art PSM re-ranking algorithms} After
  ...
  to compute accurate $p$~values \cite{klammer:statistical}.
...
procedure are given in \cite{klammer:statistical}.
...
\cite{klammer:statistical, kall:semi-supervised}, the $p$~value calculation
