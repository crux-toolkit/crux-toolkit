...
\begin{figure}
  ...
  \includegraphics[width=3in]{../../results/paper-figure/turbo/indexing-yeast-windows.eps} & 
  \includegraphics[width=3in]{../../results/paper-figure/turbo/indexing-yeast-windows.eps} \\
...
\end{tabular}
  ...
  spectra against the yeast (left, A and C) or human protein databases
  (right, B and D) on computers running the Linux (top, A and B) 
  or Windows (bottom, C and D) operating systems.
  Run time is plotted 
  as a function of the mass tolerance used to define candidate
  peptides. The four series (three for Linux) 
  correspond to searching with {\sc
  Sequest} and Crux with and without a peptide index.
  The Linux OS plots have three series
