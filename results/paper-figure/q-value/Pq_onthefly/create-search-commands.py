...
for line in fh:
  ...
  cmd = "cd %s; %s --verbosity 100 --output-mode sqt --sqt-output-file %s.sqt --decoy-sqt-output-file %s-decoy.sqt --number-decoy-set 1 --spectrum-min-mass %.3f --spectrum-max-mass %.3f %s >& %s.err \n" \
