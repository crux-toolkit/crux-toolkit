...
#------------
# ./match_analysis `pwd` $FASTA --verbosity 30 --feature-file match_analysis.features --parameter-file $PARAM_FILE --algorithm percolator
# (./match_analysis `pwd` $FASTA --feature-file match_analysis.features --parameter-file $PARAM_FILE --algorithm percolator > $OUTPUT  )>& error
