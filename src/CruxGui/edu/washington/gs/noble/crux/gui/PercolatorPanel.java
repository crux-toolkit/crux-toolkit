...
class PercolatorPanel extends JPanel implements ItemListener {
	...
	public PercolatorPanel(CruxAnalysisModel model, final CruxComponentButton button, final JToggleButton dummy) {
		super();
		this.model = model;
		this.button = button;
	...
	public void itemStateChanged(final ItemEvent event) {
		logger.info("User selected percolator component.");
		updateFromModel();
