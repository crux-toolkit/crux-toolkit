...
class QValuePanel extends JPanel implements ItemListener {
	...
	public QValuePanel(CruxAnalysisModel model, final CruxComponentButton button, final JToggleButton dummy) {
		super();
		this.model = model;
		this.button = button;
