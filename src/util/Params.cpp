...
//  InitArgParam("index name", "output tide index");
  ...
  InitStringParam("predrt-files", "",
    ...
    "If there are multiple files, delimited by comma. Within each file, the peptide and "
    "the predicted retention time are delimited by tab. The header is optional.",
