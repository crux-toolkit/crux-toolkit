...
//  InitArgParam("index name", "output tide index");
  ...
  InitStringParam("predrt-files", "",
        "The tab file containing the mapping from peptide sequence to the predicted retention time. "
        "If there are multiple files, delimited by comma. Within each file, the peptide and predrt "
        "are delimited by tab. The header is optional.",
        "It is optional but recommended for DIAmeter. It can be easily generated by DeepRT or any off-the-shelf "
        "RT prediction tools by feeding in the peptide-list genereated by tide-index ", true);
