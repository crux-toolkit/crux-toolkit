#ifndef INSPECT_RESULT_H
#define INSPECT_RESULT_H
...
class InspectResult : public SearchResult {

 public:

  InspectResult(char* szBuf, Boolean preexisting_probs);
  InspectResult(Array<Tag*>* tags);
