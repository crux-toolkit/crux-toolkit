#include "MSFraggerResult.h"

/*

Program       : MSFraggerResult for discr_calc of PeptideProphet 
...
MSFraggerResult::MSFraggerResult(char* szBuf, Boolean preexisting_probs){
  init();
...
MSFraggerResult::MSFraggerResult(Array<Tag*>* tags) : SearchResult(tags) {
...
/*
char* MSFraggerResult::extractDatabase(char* html) {
  char start[] = "&amp;Db=";
  char stop[] = "&amp";
...
void MSFraggerResult::process(char* szBuf, Boolean preexisting_probs, char* valid) {
}

const char* MSFraggerResult::getName() {
  return "MSFragger";
}
