...
MyrimatchResult::MyrimatchResult(char* szBuf, Boolean preexisting_probs){
  init();
...
MyrimatchResult::MyrimatchResult(Array<Tag*>* tags) : SearchResult(tags) {
...
/*
char* MyrimatchResult::extractDatabase(char* html) {
  char start[] = "&amp;Db=";
  char stop[] = "&amp";
...
void MyrimatchResult::process(char* szBuf, Boolean preexisting_probs, char* valid) {
}

const char* MyrimatchResult::getName() {
  return "Myrimatch";
}
