...
//
mzParser::RAMPFILE *cached_ramp_rampOpenFile(const char *filename);
void cached_ramp_rampCloseFile(mzParser::RAMPFILE *pFI);
mzParser::ramp_fileoffset_t cached_ramp_getIndexOffset(mzParser::RAMPFILE *pFI);
mzParser::ramp_fileoffset_t *cached_ramp_readIndex(mzParser::RAMPFILE *pFI,
                mzParser::ramp_fileoffset_t indexOffset,
                int *iLastScan);
void cached_ramp_readHeader(mzParser::RAMPFILE *pFI,
                mzParser::ramp_fileoffset_t lScanIndex, // read from this file position
                struct mzParser::ScanHeaderStruct *scanHeader);
const struct mzParser::ScanHeaderStruct *cached_ramp_readHeader(mzParser::RAMPFILE *pFI,
                mzParser::ramp_fileoffset_t lScanIndex); // read from this file position
int  cached_ramp_readMsLevel(mzParser::RAMPFILE *pFI,
                 mzParser::ramp_fileoffset_t lScanIndex);
double cached_ramp_readStartMz(mzParser::RAMPFILE *pFI,
		   mzParser::ramp_fileoffset_t lScanIndex);
double cached_ramp_readEndMz(mzParser::RAMPFILE *pFI,
		   mzParser::ramp_fileoffset_t lScanIndex);
int cached_ramp_readPeaksCount(mzParser::RAMPFILE *pFI,
                 mzParser::ramp_fileoffset_t lScanIndex);
mzParser::RAMPREAL *cached_ramp_readPeaks(mzParser::RAMPFILE *pFI,
                 mzParser::ramp_fileoffset_t lScanIndex);
const mzParser::RAMPREAL *cached_ramp_readPeaks_const(mzParser::RAMPFILE *pFI,
                 mzParser::ramp_fileoffset_t lScanIndex);
void cached_ramp_readRunHeader(mzParser::RAMPFILE *pFI,
                   mzParser::ramp_fileoffset_t *pScanIndex,
                   struct mzParser::RunHeaderStruct *runHeader,
                   int iLastScan);
void cached_ramp_readMSRun(mzParser::RAMPFILE *pFI,
                   struct mzParser::RunHeaderStruct *runHeader);
