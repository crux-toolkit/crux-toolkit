...
class ASAPRatioPeptideParserTagListComparator : public TagListComparator {
 public:
  ASAPRatioPeptideParserTagListComparator(const char *progname,eTagListFilePurpose why,const Array<Tag*> &lhs,const char *rhsFilename); // read from file then compare
