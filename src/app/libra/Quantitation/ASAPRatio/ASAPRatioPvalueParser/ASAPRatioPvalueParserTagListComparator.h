...
class ASAPRatioPvalueParserTagListComparator : public TagListComparator {
 public:
  ASAPRatioPvalueParserTagListComparator(const char *progname,eTagListFilePurpose why,const Array<Tag*> &lhs,const char *rhsFilename); // read from file then compare
 protected:
