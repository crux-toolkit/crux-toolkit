...
void PeptideLite::getModifications(int mod_precision, string& mod_crux_string, string& mod_mztab_string) {
  // If the peptide is reported more than once then reuse the strings from previous calculations  
...
bool PeptideLite::find_static_mod(const pb::ModTable* mod_table, char AA, double& mod_mass, string& mod_name) {
...
bool PeptideLite::find_variable_mod(const pb::ModTable* mod_table, char AA, double mod_mass, string& mod_name) {
