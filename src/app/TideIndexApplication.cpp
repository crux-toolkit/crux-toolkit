...
*/    
 ...
 // Start tide-index
  ...
  try {
    ...
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tauto-modifications-spectra = " << Params::GetString("auto-modifications-spectra") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tclip-nterm-methionine = " << Params::GetString("clip-nterm-methionine") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tisotopic-mass = " << Params::GetString("isotopic-mass") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmax-length = " << Params::GetInt("max-length") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmax-mass = " << Params::GetDouble("max-mass") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmin-length = " << Params::GetInt("min-length") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmin-mass = " << Params::GetDouble("min-mass") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tcterm-peptide-mods-spec = " << Params::GetString("cterm-peptide-mods-spec") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tcterm-protein-mods-spec = " << Params::GetString("cterm-protein-mods-spec") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmax-mods = " << Params::GetInt("max-mods") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmin-mods = " << Params::GetInt("min-mods") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmod-precision = " << Params::GetInt("mod-precision") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmods-spec = " << Params::GetString("mods-spec") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tnterm-peptide-mods-spec = " << Params::GetString("nterm-peptide-mods-spec") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tnterm-protein-mods-spec = " << Params::GetString("nterm-protein-mods-spec") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tauto-modifications = " << Params::GetString("auto-modifications") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tallow-dups = " << Params::GetString("allow-dups") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tdecoy-format = " << Params::GetString("decoy-format") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tkeep-terminal-aminos = " << Params::GetString("keep-terminal-aminos") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tnum-decoys-per-target = " << numDecoys <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tseed = " << Params::GetString("seed") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tcustom-enzyme = " << Params::GetString("custom-enzyme") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tdigestion = " << Params::GetString("digestion") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tenzyme = " << Params::GetString("enzyme") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmissed-cleavages = " << Params::GetInt("missed-cleavages") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tdecoy-prefix = " << Params::GetString("decoy-prefix") <<"\n";
    mzTabStream << "MTD\tsoftware[1]-settings[" << cnt++ << "]\tmass-precision = " << Params::GetInt("mass-precision") <<"\n";
