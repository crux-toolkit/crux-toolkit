 ...
 */
  ...
  set_string_parameter("spectrum records file", NULL,
    "A spectrum records file generated by msconvert for use with Tide.",
    "",
    "true"
  );

  set_string_parameter("tide peptides file", NULL,
    "A peptide index file generated by tide-index.",
    "",
    "true"
  );
  set_string_parameter("tide proteins file", NULL,
    "A protein index file generated by tide-index.",
    "",
    "true"
  );
  set_string_parameter("tide results file", NULL,
    "A results file generated by tide-search.",
    "",
    "true"
  );
  // **** tide options ****
  ...
  set_string_parameter("aux-locations", NULL,
    "File of auxiliary locations created by tide-index during the indexing "
    "process. Only used if show-all-proteins is true.",
    "Available for tide-results",
    "true"
  );
  set_string_parameter("out-filename", "",
    "Name of output file to generate.",
    "Available for tide-results",
    "true"
  );
  set_boolean_parameter("show-all-proteins", false,
    "Display all proteins the peptide was found in. "
    "Requires aux-locations to be set. "
    "Default F",
    "Available for tide-results",
    "true"
  );
  set_boolean_parameter("show-mods", false,
    "Display modifications in the peptide sequence. "
    "Default F",
    "Available for tide-results",
    "true"
  );
  set_string_parameter("out-format", "text",
    "The output format to be generated. Can be text, pep.xml or sqt. "
    "Default text",
    "Available for tide-results",
    "true"
  );
  set_string_parameter("spectrum-fields", "spectrum_num,mz,charge",
    "A comma delimited set of fields to show for an experimental spectrum in "
    "the order listed. Available options are: spectrum_num,mz,charge. "
    "Default spectrum_num,mz,charge",
    "Available for tide-results",
    "false"
  );
  set_string_parameter("match-fields", "xcorr,sequence",
    "A comma delimited set of fields to show for a matching peptide in the "
    "order listed. Available options are: xcorr, sequence. "
    "Default xcorr,sequence",
    "Available for tide-results",
    "false"
  );
  set_string_parameter("protein-fields", "protein_name,pos,aa_before,aa_after",
    "A comma delimited set of fields to show for a protein associated with a "
    "matching peptide. Available options are: protein_name, pos, aa_before, "
    "aa_after. "
  ...
  set_int_parameter("top-matches", 5, 0, BILLION,
    "Specify the number of matches to report for each spectrum. "
    "Default 5",
    "Available for tide-search",
    "true"
  );
  set_string_parameter("results", "text",
    "Specify whether output should be in text format or binary (protobuf) "
    "format. The protobuf format is readable by tide-results. "
    "<string>=text|protobuf "
    "Default text",
    "Available for tide-search",
    "true"
  );
