\chapter{Supplement to ``Faster SEQUEST Searching for Peptide
...
\section{Linearizing Background Subtraction \label{section:linearize-bkgnd-sub}}
...
\section{Join with Rolling Window \label{section:join}}
