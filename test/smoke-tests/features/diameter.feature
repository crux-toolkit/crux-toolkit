...
Examples:
  ...
  |diameter_scale      |--top-match 5 --prec-ppm 10 --frag-ppm 10 |diameter_test.mzXML|small-yeast.fasta|diameter-search.scaled.txt  |diameter-search.scaled.txt|
  |diameter_filter     |--top-match 5 --prec-ppm 10 --frag-ppm 10 |diameter_test.mzXML|small-yeast.fasta|diameter-search.filtered.txt|diameter-search.filtered.txt|
