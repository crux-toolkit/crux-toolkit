...
Examples:
  ...
  |exact_pval       |--score "exact p-value" --smaller-is-better T                                   |assign-exactpval.target.txt|assign-confidence.target.txt|assign-confidence-exact-tdc.target.txt   |
  |exact_pval_mixmax|--score "exact p-value" --smaller-is-better T --estimation-method mix-max       |assign-exactpval.target.txt|assign-confidence.target.txt|assign-confidence-mixmax.target.txt      |
  |sidak            |--score "exact p-value" --smaller-is-better T --sidak T                         |assign-exactpval.target.txt|assign-confidence.target.txt|assign-confidence-sidak.target.txt       |
  |peptide-level    |--score "exact p-value" --smaller-is-better T --estimation-method peptide-level |assign-exactpval.target.txt|assign-confidence.target.txt|assign-confidence-peptidelevel.target.txt|
