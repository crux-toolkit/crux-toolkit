...
Examples:
  ...
  |peptide-level    |--score "exact p-value" --smaller-is-better T --peptide-level T          |assign-exactpval.target.txt|assign-confidence.target.txt|assign-confidence-peptidelevel.target.txt|
