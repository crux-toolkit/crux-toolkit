...
Examples:
  ...
  |tide-exact-pval-1thread|                                                     |--precursor-window 3 --precursor-window-type mass --exact-p-value T --num-threads 1 --mz-bin-width 1.0005079                      |small-yeast.fasta|tide_test_index|demo.ms2|tide-search.target.txt|tide-exact-pval-1.txt|
  |tide-exact-pval-7thread|                                                     |--precursor-window 3 --precursor-window-type mass --exact-p-value T --num-threads 7 --mz-bin-width 1.0005079                      |small-yeast.fasta|tide_test_index|demo.ms2|tide-search.target.txt|tide-exact-pval-7.txt|
  ...
  |tide-isoerrpval|                                                             |--precursor-window 3 --precursor-window-type mass --isotope-error 1,2,3 --exact-p-value T --num-threads 1 --mz-bin-width 1.0005079 |small-yeast.fasta|tide_test_index|demo.ms2|tide-search.target.txt|tide-isoerrpval.txt|
  ...
  |tide-resEv-pval-1thread|                                                     |--precursor-window 3 --precursor-window-type mass --score-function residue-evidence --exact-p-value T --num-threads 1 --use-neutral-loss-peaks F --mz-bin-width 1.0005079|small-yeast.fasta|tide_test_index|demo.ms2|tide-search.target.txt|tide-resEv-1.txt   |
  |tide-resEv-pval-7thread|                                                     |--precursor-window 3 --precursor-window-type mass --score-function residue-evidence --exact-p-value T --num-threads 7 --use-neutral-loss-peaks F --mz-bin-width 1.0005079|small-yeast.fasta|tide_test_index|demo.ms2|tide-search.target.txt|tide-resEv-7.txt   |
  ...
  |tide-deiso-pval|                                                             |--precursor-window 3 --precursor-window-type mass --deisotope 10 --exact-p-value t --num-threads 1 --mz-bin-width 1.0005079       |small-yeast.fasta|tide_test_index|demo.ms2|tide-search.target.txt|tide-deiso-pval.txt|
