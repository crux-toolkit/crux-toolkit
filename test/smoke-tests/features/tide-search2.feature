...
Examples:
  ...
  |tide-speccharge-fa|                                                             |--precursor-window 3 --precursor-window-type mass --max-precursor-charge 3 --min-precursor-charge 3 --mz-bin-width 1.0005079      |tide_test_index|demo.ms2|tide-search.target.txt|tide-speccharge.txt|
