...
replot "tide-res-ev/tide-search.q.txt" using 1:0 title "Tide res-ev" with lines lw 1
replot "tide-tailor/tide-search.q.txt" using 1:0 title "Tide Tailor" with lines lw 1
set output
replot
